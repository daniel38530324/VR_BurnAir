...
public class Level2Manager_PC : MonoBehaviour
{
    [Header("GameManager")]
    ...
    public Level2State_PC level2State;
    float timer = 90;
    bool timerState;
    float levelTimer = 0;
    ...
    private void Awake()
    {
        ...
        UpdateLevel2State(Level2State_PC.Explain);
    }
    ...
    private void Update()
    {
        if(Input.GetKeyDown(KeyCode.V)){
            if(level2State == Level2State_PC.Fire){
                fireCount = 4;
                UpdateFireCount();
            }else if(level2State == Level2State_PC.Combustibles){
                combustiblesCount = 4;
    ...
    public void ReturnLevelState(Level2State_PC newState)
    {
        switch(newState)
        {
            case Level2State_PC.Fire:
    ...
    {
        UpdateLevel2State((Level2State_PC)newState);
    }
    ...
    public void UpdateCombustiblesCount()
    {
        ...
        {
            UpdateLevel2State(Level2State_PC.Fire);
        }
    }
    ...
    public void UpdateFireCount()
    {
        ...
        if(fireCount >= 4)
        {
            UpdateLevel2State(Level2State_PC.Success);
        }
    }
    ...
    IEnumerator KnowledgePoints(GameObject knowledgePoint, bool wait)
    {
        ...
        if(level2State != Level2State_PC.Success && level2State != Level2State_PC.CombustiblesFail && level2State != Level2State_PC.FireFail)
        {
            timerState = true;
        }
    ...
    public void TestBtn()
    {
        UpdateLevel2State(Level2State_PC.Test);
    }
